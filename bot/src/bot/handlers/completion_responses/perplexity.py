...
from bot.handlers.completion_responses.utils import _get_raw_dialog_messages
...
async def _get_dialog_messages_context(message_obj: types.Message, depth: int = 2) -> list[PerplexityChatMessageIn]:
    ...
    """
    raw_messages = await _get_raw_dialog_messages(bot_chat_messages_cache, message_obj, depth)
