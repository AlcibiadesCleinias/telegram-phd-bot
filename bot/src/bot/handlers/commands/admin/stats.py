...
from bot.misc import dp, bot_chat_messages_cache, bot_openai_contributor_chat_storage, bot_chats_storage
...
async def handle_show_openai_token_stats(message: types.Message, bot: Bot, *args, **kwargs):
    ...
    return await _show_all_chats_stats(message.chat.id, bot, bot_openai_contributor_chat_storage)
